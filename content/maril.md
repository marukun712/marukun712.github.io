...
- [HackTheBox Hacker](https://app.hackthebox.com/profile/2134559)
...
- その他アニメ
	- ゆゆ式、きんモザ、ゆるゆり、あいまいみー、プリキュア etc...

- カメラ
	- Panasonic LUMIX DMC-GH3を使っています
	- レンズは単焦点使いがち
...
`aikyo`は、**人間と複数のAIコンパニオンが対等に会話**し、共存できる環境を 設計するための新しいフレームワークです。近年のLLMの進歩に伴い、多くのAI Agent 実装やA2Aプロトコルが登場していますが、その多くは業務や作業効率化を目的と しています。`aikyo`は、業務や作業の効率化としてではなく、人間に寄り添い、 対等な会話をすることができるA2Aを目指しています。
...
Stellarは、ATProtocolでカスタムBluemojiリアクションを実装した、[Ouranos](https://github.com/pdelfan/ouranos/)ベースのBluesky Webクライアントです。

## VRMeet 

https://github.com/marukun712/VRMeet

必要なものはWebカメラだけ。Web上で手軽に複数人での3Dコラボを行うことができます。

Joyo High school テックコンテスト受賞作品
...
第5回 Joyo High school テックコンテスト テック特別賞

2025年度 未踏ジュニア スーパークリエイタ

2025年度 SecHack365 開発駆動 仲山ゼミ

N高研究部 2025年度6月入部

第4回 Joyo High school テックコンテスト テック特別賞

# 展示/発表

Interop Tokyo 2026 NICTブース

SecHack365 2025年度 成果発表会
